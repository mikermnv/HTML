function cs142MakeMultiFilter(originalArray) {
    ...
    function arrayFilterer(filterCriteria, callback) {
      ...
      if (typeof callback === 'function') {
        callback.call(originalArray, currentArray); // Call callback by passing the current array and setting this to originalArray
      }
  
      return arrayFilterer; /// Returning ourselves to be able to chain calls
    }
